<script lang="ts">
	...
	const footerLinks = {
		company: [
			...
			{ label: 'Heritage Difference', href: '/heritage-berkshire-difference' },
			{ label: 'Products', href: '/products' },
			{ label: 'Contact', href: '/contact-us' }
		],
		support: [
			{ label: 'Cooking Guide', href: '#' },
			...
			<div class="lg:col-span-2">
				...
				<div class="flex gap-4">
					{#each socialLinks as social}
						<a
							href={social.href}
							class="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 text-white hover:bg-[#c9a86c] hover:text-[#1a1a1a] transition-colors"
			...
			<div>
				...
				<ul class="space-y-3">
					{#each footerLinks.company as link}
						<li>
							<a href={link.href} class="text-gray-400 hover:text-[#c9a86c] transition-colors">
								{link.label}
							</a>
						</li>
					{/each}
